...
//local imports
import webCrawler.UrlName;
import webCrawler.Storage;
import webCrawler.DobbySpiderBot;
import webCrawler.LogInBot;
...
public class EthCrawler {
	public static void main(String[] args) {
		...
		urls.add(new UrlName("NameOfMyWebsite", myWebsiteUrl, false)); //last argument can be set if moodle login is requiered
